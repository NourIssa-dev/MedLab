...
import com.github.adminfaces.ft.pages.GuarantorListPage;
...
public class AdminFt {
    ...
    @Page
    private GuarantorListPage carList;
    ...
    @Test
    @InSequence(9)
    public void shouldInsertCar(@InitialPage GuarantorListPage carList) {
        carList.newCar();
    ...
    @Test
    @InSequence(10)
    public void shouldSearchCarByNameAndPrice(@InitialPage GuarantorListPage carList) {
        carList.search();
