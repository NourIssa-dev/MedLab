...
@Location("guarantors-list.xhtml")
public class GuarantorListPage {
    ...
    public boolean isPresent() {
        return header.isPresent() && header.getText().contains("Guarantor listing Find guarantors by name, price and model");
    }
